package com.stevelinz.dependentcopy;
...
public class Copier {
    ...
    com.stevelinz.dependentcopy.KeyboardReader reader;
    com.stevelinz.dependentcopy.ScreenWriter writer;
     ...
     */
    public Copier(com.stevelinz.dependentcopy.KeyboardReader reader, com.stevelinz.dependentcopy.ScreenWriter writer) {
        this.reader = reader;
        this.writer = writer;
    }
